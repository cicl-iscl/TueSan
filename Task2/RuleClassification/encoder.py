...
class Encoder(nn.Module):
    ...
    def __init__(
        self, vocabulary_size, embedding_dim, hidden_dim, ngram,
        char2token_mode = 'rnn', dropout=0.0
    ):
        super().__init__()
        ...
        self.char_encoder = ConvNgramEncoder(embedding_dim, hidden_dim, ngram, dropout=dropout)
        ...
        # on context
        self.context_encoder = LSTM(hidden_dim, hidden_dim, num_layers=2, dropout=dropout)
    ...
    def forward(self, inputs):
        ...
        token_indices = (token_lengths.flatten() != 0).nonzero().flatten()
        ...
        noncontextual_embeddings = self.char2token(char_embeddings)
        ...
        contextual_embeddings = self.context_encoder(contextual_embeddings, sent_lengths)

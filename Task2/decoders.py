...
def mlp_classifier_factory(input_dim, hidden_dim, num_classes,
...
class RecurrentDecoder(nn.Module):
    ...
    """
    def __init__(self, vocab_size, embedding_size, encoder_output_size,
                 hidden_size, num_layers, dropout = 0.0):
        super().__init__()
    ...
    def _forward_step(self, last_output, encoder_output,
                      encoder_char_embeddings, encoder_char_lengths,
                      hidden=None):
    ...
    def forward(self, targets, encoder_output, encoder_char_embeddings,
        ...
        for i in range(num_chars):
            ...
            output, hidden = self._forward_step(
                last_output, encoder_output, encoder_char_embeddings,
                encoder_char_lengths, hidden=hidden
                )

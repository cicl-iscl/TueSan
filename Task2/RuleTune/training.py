...
def train(model, optimizer, dataloader, epochs, device, tag_rules, checkpoint_dir=None):
    ...
    for epoch in range(epochs):
        ...
        # Choose which metric(s) to report
        tune.report(loss=running_stem_loss + running_tag_loss)
